    ...
    <footer class="mt-auto py-3 text-center text-muted small shadow-sm" style="background: #fff; border-top: 1px solid #e0e0e0;">
        <div class="container">
            <p class="mb-1">&copy; 2026 <strong>Unit Penjaminan Mutu</strong> &bull; Politeknik Gajah Tunggal</p>
            <p class="mb-0 text-secondary" style="font-size: 0.85em;">Sistem Penjaminan Mutu Internal (SPMI)</p>
        </div>
    </footer>
